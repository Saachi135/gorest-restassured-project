...
public class PostsAssertionTest {
    ...
    //2. Verify the if the title of id = 40098 is equal to ”Qui sub magnam acquiro carcer.”
    @Test
    public void test002() {
        response
    ...
    //4. Check the multiple ids in the ArrayList (2329073, 2329068, 2329065)
    @Test
    public void test004() {
        response.body("user_id", hasItems(2329073, 2329068, 2329065));
    }
